...
export default function page() {
  ...
  const acceptMessages = watch('accpetMessages')
  ...
  const copyToClipboard = () => {
    ...
    toast({
      title:'url copied',
      description: "profile url hase been copied to clipboard"
    }) 
  }
  ...
  return (
    <div className='my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-whie rounded w-full max-w-6xl'>
      <h1 className='text-4xl font-bold mb-4'>User Dashboard</h1>
      <div className='mb-4'>
        <h2 className='text-lg font-semibold mb-2'>
          copy yout Unique Link
        </h2>{' '}
